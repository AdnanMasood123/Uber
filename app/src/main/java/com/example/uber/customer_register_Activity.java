...
public class customer_register_Activity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        AlreadyAccount.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Intent intent=new Intent(getApplicationContext(),customer_login_Activity.class);
...
*/
                        ...
                        Toast.makeText(customer_register_Activity.this, "Account Created SuccessFully", Toast.LENGTH_SHORT).show();

                    }
                    else
                    {
                        String message = task.getException().toString();
                        Toast.makeText(customer_register_Activity.this, "Error" + message, Toast.LENGTH_SHORT).show();
